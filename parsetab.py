...
_lr_productions = [
  ...
  ('program -> PROGRAM ID SEMICOLON prog_vars prog_funcs MAIN body END','program',8,'p_program','main.py',298),
  ('prog_vars -> vars','prog_vars',1,'p_prog_vars','main.py',303),
  ('prog_vars -> empty','prog_vars',1,'p_prog_vars','main.py',304),
  ('prog_funcs -> funcs prog_funcs','prog_funcs',2,'p_prog_funcs','main.py',308),
  ('prog_funcs -> empty','prog_funcs',1,'p_prog_funcs','main.py',309),
  ('body -> LBRACE body_prime RBRACE','body',3,'p_body','main.py',316),
  ('body_prime -> statement body_prime','body_prime',2,'p_body_prime','main.py',320),
  ('body_prime -> empty','body_prime',1,'p_body_prime','main.py',321),
  ('assign -> ID EQUALS expression SEMICOLON','assign',4,'p_assign','main.py',328),
  ('expression -> exp expression_prime','expression',2,'p_expression','main.py',351),
  ('expression_prime -> GREATER exp','expression_prime',2,'p_expression_prime','main.py',380),
  ('expression_prime -> LESS exp','expression_prime',2,'p_expression_prime','main.py',381),
  ('expression_prime -> NOT_EQUALS exp','expression_prime',2,'p_expression_prime','main.py',382),
  ('expression_prime -> empty','expression_prime',1,'p_expression_prime','main.py',383),
  ('cte -> CTE_INT','cte',1,'p_cte','main.py',390),
  ('cte -> CTE_FLOAT','cte',1,'p_cte','main.py',391),
  ('funcs -> VOID ID LPAREN funcs_prime RPAREN LBRACKET funcs_vars body RBRACKET SEMICOLON','funcs',10,'p_funcs','main.py',395),
  ('funcs_prime -> ID COLON type more_funcs','funcs_prime',4,'p_funcs_prime','main.py',409),
  ('funcs_prime -> empty','funcs_prime',1,'p_funcs_prime','main.py',410),
  ('more_funcs -> COMMA ID COLON type more_funcs','more_funcs',5,'p_more_funcs','main.py',417),
  ('more_funcs -> empty','more_funcs',1,'p_more_funcs','main.py',418),
  ('funcs_vars -> vars','funcs_vars',1,'p_funcs_vars','main.py',425),
  ('funcs_vars -> empty','funcs_vars',1,'p_funcs_vars','main.py',426),
  ('statement -> assign','statement',1,'p_statement','main.py',430),
  ('statement -> condition','statement',1,'p_statement','main.py',431),
  ('statement -> cycle','statement',1,'p_statement','main.py',432),
  ('statement -> f_call','statement',1,'p_statement','main.py',433),
  ('statement -> print','statement',1,'p_statement','main.py',434),
  ('exp -> term exp_prime','exp',2,'p_exp','main.py',438),
  ('exp_prime -> PLUS term exp_prime','exp_prime',3,'p_exp_prime','main.py',450),
  ('exp_prime -> MINUS term exp_prime','exp_prime',3,'p_exp_prime','main.py',451),
  ('exp_prime -> empty','exp_prime',1,'p_exp_prime','main.py',452),
  ('term -> factor term_prime','term',2,'p_term','main.py',459),
  ('term_prime -> TIMES factor term_prime','term_prime',3,'p_term_prime','main.py',471),
  ('term_prime -> DIVIDE factor term_prime','term_prime',3,'p_term_prime','main.py',472),
  ('term_prime -> empty','term_prime',1,'p_term_prime','main.py',473),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','main.py',480),
  ('factor -> PLUS factor_prime','factor',2,'p_factor','main.py',481),
  ('factor -> MINUS factor_prime','factor',2,'p_factor','main.py',482),
  ('factor -> factor_prime','factor',1,'p_factor','main.py',483),
  ('factor_prime -> ID','factor_prime',1,'p_factor_prime','main.py',492),
  ('factor_prime -> cte','factor_prime',1,'p_factor_prime','main.py',493),
  ('vars -> VAR vars_prime','vars',2,'p_vars','main.py',505),
  ('vars_prime -> ID id COLON type SEMICOLON vars_prime','vars_prime',6,'p_vars_prime','main.py',509),
  ('vars_prime -> empty','vars_prime',1,'p_vars_prime','main.py',510),
  ('id -> COMMA ID id','id',3,'p_id','main.py',530),
  ('id -> empty','id',1,'p_id','main.py',531),
  ('type -> INT','type',1,'p_type','main.py',538),
  ('type -> FLOAT','type',1,'p_type','main.py',539),
  ('print -> PRINT LPAREN print_prime RPAREN SEMICOLON','print',5,'p_print','main.py',543),
  ('print_prime -> expression more_print','print_prime',2,'p_print_prime','main.py',547),
  ('print_prime -> CTE_STRING more_print','print_prime',2,'p_print_prime','main.py',548),
  ('more_print -> COMMA more_print_prime more_print','more_print',3,'p_more_print','main.py',552),
  ('more_print -> empty','more_print',1,'p_more_print','main.py',553),
  ('more_print_prime -> expression','more_print_prime',1,'p_more_print_prime','main.py',560),
  ('more_print_prime -> CTE_STRING','more_print_prime',1,'p_more_print_prime','main.py',561),
  ('cycle -> WHILE LPAREN expression RPAREN DO body SEMICOLON','cycle',7,'p_cycle','main.py',565),
  ('condition -> IF LPAREN expression RPAREN body else_condition SEMICOLON','condition',7,'p_condition','main.py',569),
  ('else_condition -> ELSE body','else_condition',2,'p_else_condition','main.py',573),
  ('else_condition -> empty','else_condition',1,'p_else_condition','main.py',574),
  ('f_call -> ID LPAREN f_call_prime RPAREN SEMICOLON','f_call',5,'p_f_call','main.py',581),
  ('f_call_prime -> expression more_f_call','f_call_prime',2,'p_f_call_prime','main.py',585),
  ('f_call_prime -> empty','f_call_prime',1,'p_f_call_prime','main.py',586),
  ('more_f_call -> COMMA expression more_f_call','more_f_call',3,'p_more_f_call','main.py',593),
  ('more_f_call -> empty','more_f_call',1,'p_more_f_call','main.py',594),
  ('empty -> <empty>','empty',0,'p_empty','main.py',601),
]

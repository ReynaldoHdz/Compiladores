...
_lr_productions = [
  ...
  ('program -> PROGRAM ID SEMICOLON prog_vars prog_funcs MAIN body END','program',8,'p_program','main.py',286),
  ('prog_vars -> vars','prog_vars',1,'p_prog_vars','main.py',291),
  ('prog_vars -> empty','prog_vars',1,'p_prog_vars','main.py',292),
  ('prog_funcs -> funcs prog_funcs','prog_funcs',2,'p_prog_funcs','main.py',296),
  ('prog_funcs -> empty','prog_funcs',1,'p_prog_funcs','main.py',297),
  ('body -> LBRACE body_prime RBRACE','body',3,'p_body','main.py',304),
  ('body_prime -> statement body_prime','body_prime',2,'p_body_prime','main.py',308),
  ('body_prime -> empty','body_prime',1,'p_body_prime','main.py',309),
  ('assign -> ID EQUALS expression SEMICOLON','assign',4,'p_assign','main.py',316),
  ('expression -> exp expression_prime','expression',2,'p_expression','main.py',329),
  ('expression_prime -> GREATER exp','expression_prime',2,'p_expression_prime','main.py',342),
  ('expression_prime -> LESS exp','expression_prime',2,'p_expression_prime','main.py',343),
  ('expression_prime -> NOT_EQUALS exp','expression_prime',2,'p_expression_prime','main.py',344),
  ('expression_prime -> empty','expression_prime',1,'p_expression_prime','main.py',345),
  ('cte -> CTE_INT','cte',1,'p_cte','main.py',352),
  ('cte -> CTE_FLOAT','cte',1,'p_cte','main.py',353),
  ('funcs -> VOID ID LPAREN funcs_prime RPAREN LBRACKET funcs_vars body RBRACKET SEMICOLON','funcs',10,'p_funcs','main.py',357),
  ('funcs_prime -> ID COLON type more_funcs','funcs_prime',4,'p_funcs_prime','main.py',371),
  ('funcs_prime -> empty','funcs_prime',1,'p_funcs_prime','main.py',372),
  ('more_funcs -> COMMA ID COLON type more_funcs','more_funcs',5,'p_more_funcs','main.py',379),
  ('more_funcs -> empty','more_funcs',1,'p_more_funcs','main.py',380),
  ('funcs_vars -> vars','funcs_vars',1,'p_funcs_vars','main.py',387),
  ('funcs_vars -> empty','funcs_vars',1,'p_funcs_vars','main.py',388),
  ('statement -> assign','statement',1,'p_statement','main.py',392),
  ('statement -> condition','statement',1,'p_statement','main.py',393),
  ('statement -> cycle','statement',1,'p_statement','main.py',394),
  ('statement -> f_call','statement',1,'p_statement','main.py',395),
  ('statement -> print','statement',1,'p_statement','main.py',396),
  ('exp -> term exp_prime','exp',2,'p_exp','main.py',400),
  ('exp_prime -> PLUS term exp_prime','exp_prime',3,'p_exp_prime','main.py',425),
  ('exp_prime -> MINUS term exp_prime','exp_prime',3,'p_exp_prime','main.py',426),
  ('exp_prime -> empty','exp_prime',1,'p_exp_prime','main.py',427),
  ('term -> factor term_prime','term',2,'p_term','main.py',434),
  ('term_prime -> TIMES factor term_prime','term_prime',3,'p_term_prime','main.py',446),
  ('term_prime -> DIVIDE factor term_prime','term_prime',3,'p_term_prime','main.py',447),
  ('term_prime -> empty','term_prime',1,'p_term_prime','main.py',448),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','main.py',455),
  ('factor -> PLUS factor_prime','factor',2,'p_factor','main.py',456),
  ('factor -> MINUS factor_prime','factor',2,'p_factor','main.py',457),
  ('factor -> factor_prime','factor',1,'p_factor','main.py',458),
  ('factor_prime -> ID','factor_prime',1,'p_factor_prime','main.py',467),
  ('factor_prime -> cte','factor_prime',1,'p_factor_prime','main.py',468),
  ('vars -> VAR vars_prime','vars',2,'p_vars','main.py',480),
  ('vars_prime -> ID id COLON type SEMICOLON vars_prime','vars_prime',6,'p_vars_prime','main.py',484),
  ('vars_prime -> empty','vars_prime',1,'p_vars_prime','main.py',485),
  ('id -> COMMA ID id','id',3,'p_id','main.py',505),
  ('id -> empty','id',1,'p_id','main.py',506),
  ('type -> INT','type',1,'p_type','main.py',513),
  ('type -> FLOAT','type',1,'p_type','main.py',514),
  ('print -> PRINT LPAREN print_prime RPAREN SEMICOLON','print',5,'p_print','main.py',518),
  ('print_prime -> expression more_print','print_prime',2,'p_print_prime','main.py',522),
  ('print_prime -> CTE_STRING more_print','print_prime',2,'p_print_prime','main.py',523),
  ('more_print -> COMMA more_print_prime more_print','more_print',3,'p_more_print','main.py',527),
  ('more_print -> empty','more_print',1,'p_more_print','main.py',528),
  ('more_print_prime -> expression','more_print_prime',1,'p_more_print_prime','main.py',535),
  ('more_print_prime -> CTE_STRING','more_print_prime',1,'p_more_print_prime','main.py',536),
  ('cycle -> WHILE LPAREN expression RPAREN DO body SEMICOLON','cycle',7,'p_cycle','main.py',540),
  ('condition -> IF LPAREN expression RPAREN body else_condition SEMICOLON','condition',7,'p_condition','main.py',544),
  ('else_condition -> ELSE body','else_condition',2,'p_else_condition','main.py',548),
  ('else_condition -> empty','else_condition',1,'p_else_condition','main.py',549),
  ('f_call -> ID LPAREN f_call_prime RPAREN SEMICOLON','f_call',5,'p_f_call','main.py',556),
  ('f_call_prime -> expression more_f_call','f_call_prime',2,'p_f_call_prime','main.py',560),
  ('f_call_prime -> empty','f_call_prime',1,'p_f_call_prime','main.py',561),
  ('more_f_call -> COMMA expression more_f_call','more_f_call',3,'p_more_f_call','main.py',568),
  ('more_f_call -> empty','more_f_call',1,'p_more_f_call','main.py',569),
  ('empty -> <empty>','empty',0,'p_empty','main.py',576),
]
